        ...
        <div class="log_c">
            <form action="LoginServlet" method="get" id=""loginform>
                <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="70">
                        <td>用户名</td>
                        <td><input type="text" name="loginName" id="userName" class="l_user" /></td>
                    </tr>
                    <tr height="70">
                        <td>密&nbsp; &nbsp; 码</td>
                        <td><input type="password" name="password" id="password" class="l_pwd" /></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr height="60">
                        <td>&nbsp;</td>
                        <td><input type="submit" value="登录" class="log_btn" id="login"/></td>
                    </tr>
                </table>
            </form>
        </div>
...
<script>
        $("#login").click((e)=>{
            //获取账号密码的value值(作为前端验证)
            var userName = $("#userName").val();
            var password = $("#password").val();
            //判断账号密码是否为空,如果为空就提示,且提示一遍
            if(userName==''){
                e.preventDefault()
                alert("用户名不能为空")
                return ;
