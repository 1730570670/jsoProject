		...
		<div class="m_right">
            ...
            <div class="pages">
                <c:if test="${pageCurrent>1}">
                    <a href="/eachnet/NewsServlet?pageCurrent=${pageCurrent-1}" class="p_pre">上一页</a>
                </c:if>
                <c:if test="${pageCurrent<MaxPage}">
                    <a href="/eachnet/NewsServlet?pageCurrent=${pageCurrent+1}" class="p_pre">下一页</a>
                </c:if>
            </div>
